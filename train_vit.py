...
⚠️ DEPRECATED: This file has been moved to scripts/train_model.py
Please use: python scripts/train_model.py --config configs/vit_b16_quick_test.yaml
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train ViT on occluded aircraft classification")
    parser.add_argument(
        '--config',
        type=str,
